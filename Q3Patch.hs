...
tessellate controls level = do
    let plus (DrawVertex p1 d1 l1 n1 c1) (DrawVertex p2 d2 l2 n2 c2) = DrawVertex (p1 + p2) (d1 + d2) (l1 + l2) (n1 + n2) (c1 + c2)
        ...
        l1 = level + 1
        idx row col2 | col2 `mod` 2 == 0 = (row + 1) * l1 + col2 `div` 2
    ...
    return (v,[V.generate (l1*2) (idx row) | row <- [0..level-1]])
{-
